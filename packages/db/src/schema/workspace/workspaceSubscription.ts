import { WorkspaceSubscriptionStatus, WorkspaceSubscriptionTier } from '@calmpulse-app/types';
...
export const workspaceSubscription = pgTable(
  'workspace_subscription',
  {
    ...
    tier: workspaceSubscriptionTier('tier').notNull().default(WorkspaceSubscriptionTier.FREE),
  ...
  (table) => [index('workspace_subscription_workspace_id_idx').on(table.workspaceId)],
);
